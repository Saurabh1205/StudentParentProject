...
import com.wordpro.studentproject.adapter.YouVideoDetailsAdpter;
...
public class VideoViewActionActivity extends AppCompatActivity implements OnImageClickListener {
    ...
    private YouVideoDetailsAdpter youVideoDetailsAdpter;
    ...
    private static String TAG = VideoViewActionActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgressDialog=new ProgressDialog(VideoViewActionActivity.this);
                ...
                try {
                    ...
                    if (mainNoticPatten.getStatus() == 1) {
                        ...
                        if (noticPattenSubs.size()>0){
                            youVideoDetailsAdpter = new YouVideoDetailsAdpter(VideoViewActionActivity.this, noticPattenParents,NOTICE_PATTERN);
                            newsHeaderList.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
                            newsHeaderList.setAdapter(youVideoDetailsAdpter);
                        }
                ...
                try {
                    ...
                    if (filterGroupNameModel.getStatus() == 1) {
                        ...
                        if (filterGroupList.size()>0){
                            filterGroupListAdapter = new FilterGroupListAdapter(VideoViewActionActivity.this,filterGroupList);
                            LinearLayoutManager horizontalLayoutManagaer
                                    = new LinearLayoutManager(VideoViewActionActivity.this, LinearLayoutManager.HORIZONTAL, false);
