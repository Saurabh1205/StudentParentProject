...
import com.wordpro.studentproject.fragment.PublishFragment;
import com.wordpro.studentproject.fragment.SumittedFrag;

import static com.wordpro.studentproject.network.Network.isNetworkAvailable;

public class E_LearnAssignActivity extends AppCompatActivity {
    private static String TAG = E_LearnAssignActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isNetworkAvailable(this)) {
            ...
            setContentView(R.layout.activity_e__learn_assign);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_e__learn_assign, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_e__learn_assign, container, false);
    ...
    public void onBackPressed() {
        Intent intent =new Intent(E_LearnAssignActivity.this, NavigationActivity.class);
        intent.putExtra("activity","E_LearnAssignActivity");
        startActivity(intent);
        finish();
    }
}
