...
public class NewRightEventActionActivity extends AppCompatActivity {

    private TextView txt_toolbarName,txt_viewMore;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgressDialog=new ProgressDialog(NewRightEventActionActivity.this);
                ...
                try {
                    ...
                    if (mainNoticPatten.getStatus() == 1) {
                        ...
                        if (noticPattenSubs.size()>0){
                            new_newsDetailsAdpter = new New_NewsDetailsAdpter(NewRightEventActionActivity.this, noticPattenParents,NOTICE_PATTERN);
                ...
                try {
                    ...
                    if (filterGroupNameModel.getStatus() == 1) {
                        ...
                        if (filterGroupList.size()>0){
                            filterGroupListAdapter = new FilterGroupListAdapter(NewRightEventActionActivity.this,filterGroupList);
                            LinearLayoutManager horizontalLayoutManagaer
                                    = new LinearLayoutManager(NewRightEventActionActivity.this, LinearLayoutManager.HORIZONTAL, false);
