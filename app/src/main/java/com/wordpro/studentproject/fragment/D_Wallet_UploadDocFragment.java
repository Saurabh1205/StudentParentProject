...
public class D_Wallet_UploadDocFragment extends Fragment {
    private static String TAG = D_Wallet_UploadDocFragment.class.getSimpleName();
    private LinearLayout  main_linear_view;

    D_Wallet_UploadDocFragment actionNewsFragment;
    ...
    public D_Wallet_UploadDocFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            NameOfParam=getArguments().getString("Upload");
                ...
                try {
                    ...
                    if(downloadDocModel.getStatus()==1){
                        ...
                        if(documentListDtls!=null && documentListDtls.size()!=0){
                            ...
                            d_wallet_download_list_adapter = new D_wallet_download_List_Adapter(getActivity(), documentListDtls,"Upload");
                            ...
                            d_wallet_download_list_adapter.setOnItemClickListener(new D_wallet_download_List_Adapter.OnItemClickListener() {
                                ...
                                public void onItemClick(View itemView, int position, String download) {
                                    ...
                                    fragment = new D_Wallet_Upload_DetailsFragment();
