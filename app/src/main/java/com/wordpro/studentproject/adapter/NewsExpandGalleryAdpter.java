...
public class NewsExpandGalleryAdpter extends BaseExpandableListAdapter {
    ...
    public NewsExpandGalleryAdpter(Context context, ArrayList<String> groupName, HashMap<String, List<String>> listDataChild) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            LayoutInflater infalInflater = (LayoutInflater) this._context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = infalInflater.inflate(R.layout.gallery_item_adapter, null);
        }
...
*/
    ...
    public boolean isStoragePermissionGranted() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (_context.checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)
