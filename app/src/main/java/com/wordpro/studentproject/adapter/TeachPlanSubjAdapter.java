...
public class TeachPlanSubjAdapter extends RecyclerView.Adapter<TeachPlanSubjAdapter.ViewHolder> {

    Context context;
    ArrayList<TeachPlanSubjModel.DataBean> subjectArrayList;
    /***** Creating OnItemClickListener *****/

    // Define listener member variable
    private TeachPlanSubjAdapter.OnItemClickListener listener;
    ...
    public void setOnItemClickListener(TeachPlanSubjAdapter.OnItemClickListener listener) {
        this.listener = listener;
    }
    public TeachPlanSubjAdapter(Context context, ArrayList<TeachPlanSubjModel.DataBean> subjectArrayList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.txtSubjName.setText(subjectArrayList.get(position).getSUBJECT_DESCRIPTION());
        holder.txtFacName.setText(subjectArrayList.get(position).getPROF_EMP_FN_MN_SHORT());
