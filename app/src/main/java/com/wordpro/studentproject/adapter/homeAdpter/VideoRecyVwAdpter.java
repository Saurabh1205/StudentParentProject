...
public class VideoRecyVwAdpter extends RecyclerView.Adapter<VideoRecyVwAdpter.ViewHolder> {
    ...
    public VideoRecyVwAdpter(Context context, List<String> listDataHeaderVideos, ArrayList<NoticesModel.DataBean> videosArrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.txtNewsGroupName.setVisibility(View.VISIBLE);
