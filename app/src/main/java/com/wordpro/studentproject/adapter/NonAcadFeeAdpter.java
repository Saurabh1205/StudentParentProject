...
public class NonAcadFeeAdpter extends RecyclerView.Adapter<NonAcadFeeAdpter.ViewHolder> {

    Context context;
    ArrayList<NonAcadFeesModel.DataBean> nonAcadFeesArrayList;

    public NonAcadFeeAdpter(Context context, ArrayList<NonAcadFeesModel.DataBean> nonAcadFeesArrayList) {
        this.context = context;
        this.nonAcadFeesArrayList = nonAcadFeesArrayList;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.txtParticulars.setText(nonAcadFeesArrayList.get(position).getFEE_SUB_TYPE_DESC());
        holder.txtReceivableAmt.setText(nonAcadFeesArrayList.get(position).getRECEIVABLE_AMOUNT() +" ₹");
        holder.txtReceivedAmt.setText(nonAcadFeesArrayList.get(position).getFEE_RECEIPT_AMOUNT() +" ₹");
        holder.txtAdjustment.setText(nonAcadFeesArrayList.get(position).getDISCOUNT_AMOUNT() +" ₹");
        holder.txtOutstanding.setText(nonAcadFeesArrayList.get(position).getBALANCE_AMOUNT() +" ₹");
        holder.txtAdvance.setText(nonAcadFeesArrayList.get(position).getADVN_AMT_SUBTYPEWISE() +" ₹");
    }

    @Override
    public int getItemCount() {
        return nonAcadFeesArrayList.size();
    }
